...
public class DatasetDetailDTO {
    ...
    public DatasetDetailDTO() {}

    public DatasetDetailDTO(String id, String name, String description, String source,
    ...
    public static class Builder {
        ...
        public DatasetDetailDTO build() {
            return new DatasetDetailDTO(id, name, description, source, columns, rows, stats, createdAt, updatedAt);
        }
    }
